...
class NSDA_DROPOUT(torch.nn.Module):
    """
    ...
    def __init__(self):
        ...
        self.attention = AttentionLayer(size_in = 58, size_inner = 16)
        self.linear = torch.nn.Linear(in_features = 58, out_features = 2, bias = True)
    ...
    def feature_extractor(self, x):
        ...
        return out.view(n_batch, n_channels, 58)
